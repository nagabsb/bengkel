...
<template>
    <article class="rounded-2xl border border-emerald-100 bg-white shadow-sm dark:border-emerald-500/20 dark:bg-slate-900">
        <header class="flex flex-wrap items-start justify-between gap-3 border-b border-slate-200 px-5 py-4 dark:border-slate-700">
            <div>
                <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100">Daftar Kategori Pengeluaran</h3>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Kelola master kategori pengeluaran agar pencatatan biaya lebih konsisten.</p>
            </div>
